...
class HighEnvDecider(Decider):
    ...
    def run(self):
        ...
        while not (done or truncated):
            ...
            if lateral_action in [LateralAction.CHANGE_RIGHT, LateralAction.CHANGE_LEFT]:
    ...
    def make(seeds: list[int] = None) -> "HighEnvDecider":
        if seeds is None:
            seeds = [5838, 2421, 7294, 9650, 4176, 6382, 8765, 1348,
        ...
        env = gymnasium.make('highway-v0', render_mode='rgb_array', config=env_config['highway-v0'])
